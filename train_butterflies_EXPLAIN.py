...
def main():
    ...
    teaching_set = './datasets/butterflies_crop/' + args.selection + '/butterflies_EXPLAIN_gt_tr.txt'
    ...
    for iter in range(args.iters):
        ...
        if iter == 0:
            ...
            assert callable(datasets2.__dict__['butterflies_EXPLAIN'])
            get_dataset = getattr(datasets2, 'butterflies_EXPLAIN')
            num_classes = datasets2._NUM_CLASSES['butterflies_EXPLAIN']
