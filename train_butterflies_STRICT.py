...
parser.add_argument('--Lambda', default=10.0, type=int, metavar='N',
                    help='see professor writing')
parser.add_argument('--selection', default='STRICT', help='see professor writing')
...
def main():
    ...
    teaching_set = './datasets/butterflies_crop/' + args.selection + '/butterflies_STRICT_gt_tr.txt'
    ...
    teaching_set_index = [1211, 1216, 407, 1116, 757, 1061, 1460, 1439, 247, 1133, 1191, 951, 1469, 1075, 511, 1035, 398, 579, 754, 666]
    ...
    for iter in range(args.iters):
        ...
        if iter == 0:
            ...
            added_example_indices = teaching_set_index[iter]
            added_example_indices = np.array([added_example_indices])
            ...
            assert callable(datasets2.__dict__['butterflies_STRICT'])
            get_dataset = getattr(datasets2, 'butterflies_STRICT')
            num_classes = datasets2._NUM_CLASSES['butterflies_STRICT']
